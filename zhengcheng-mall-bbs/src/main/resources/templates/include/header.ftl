    ...
    <div class="layui-container">
        ...
        <ul class="layui-nav fly-nav layui-hide-xs">
            ...
            <li class="layui-nav-item">
                <a href="${base}/case/list"><i class="iconfont icon-iconmingxinganli"></i>案例</a>
            </li>
        </ul>
        ...
        <ul class="layui-nav fly-nav-user">
            <#if isAuthenticated>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${base}/member/message/list">
                        ...
                        <dd>
                            <#if redirectUrl??>
                                <a href="${base}/logout?redirectUrl=${redirectUrl}" style="text-align: center;">退出</a>
                            <#else>
                                <a href="${base}/logout" style="text-align: center;">退出</a>
                            </#if>
                        </dd>
                    </dl>
                </li>
            <#else>
                <!-- 未登入的状态 -->
                <li class="layui-nav-item">
                    <a class="iconfont icon-touxiang layui-hide-xs" href="${base}/login/index"></a>
                </li>
                <li class="layui-nav-item">
                <#if redirectUrl??>
                    <a href="${base}/login/index?redirectUrl=${redirectUrl}">登入</a>
                <#else>
                    <a href="${base}/login/index">登入</a>
                </#if>
                </li>
                <li class="layui-nav-item">
                    <a href="${base}/register/index">注册</a>
                </li>
            <#--
